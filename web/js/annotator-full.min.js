...
! function() {
	...
	Annotator = function(_super) {
		...
		Annotator.prototype.setupAnnotation = function(annotation) {
			...
			for (_l = 0, _len3 = normedRanges.length; _l < _len3; _l++) {
				...
				var idx=$(annotation.highlights).css('background-color',window.user_colors[annotation.user_id]);
				console.log("annotation->",annotation);
				console.log("annotation burada->[",idx[0],"]","[",annotation.user_id,"]");
			}
		...
		Annotator.prototype.deleteAnnotation = function(annotation) {
			console.log("deletAnnotation=>",annotation);
		...
		Annotator.prototype.highlightRange = function(normedRange, cssClass) {
			//console.log("highlightRange",normedRange);
			...
			for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
				...
				if (!white.test(node.nodeValue)) {
					_results.push($(node).wrapAll(hl).parent().show()[0])
						...
						//console.log("highlightRange",$(_results).addClass("egemen"));
			return _results
		};
		Annotator.prototype.highlightRanges = function(normedRanges, cssClass) {
			//console.log("normedRanges",normedRanges);
		...
		Annotator.prototype.isAnnotator = function(element) {
			//console.log('geliyor->');console.log(element);
		...
		Annotator.prototype.onDeleteAnnotation = function(annotation) {
			this.viewer.hide();
			//alert("OLLLAA"+window.userIdGlobal+"---"+annotation.user_id);
			console.log("OLLAA annotation",window.userIdGlobal,annotation.user_id);
			console.log('CHECK ANNO=>',window.user_id);
			if(window.userIdGlobal==annotation.user_id)
			{
	...
	Annotator.Viewer = function(_super) {
		...
		Viewer.prototype.html = {
			...
			item: '<li class="annotator-annotation annotator-item">\n  <span class="annotator-controls">\n    <a href="#" title="View as webpage" class="annotator-link">View as webpage</a>\n    <button title="'+_t('Edit')+'" class="annotator-edit">'+_t('Edit')+'</button>\n    <button title="'+_t('Delete')+'" class="annotator-delete">'+_t('Delete')+'</button>\n  </span>\n</li>'
		};
		...
		Viewer.prototype.onButtonClick = function(event, type) {
			...
			console.log("buton basılırsa=>",this,type,item,item.data("annotation"));
	...
	Annotator.Plugin.Store = function(_super) {
		...
		function Store(element, options) {
			...
			this.annotations = []
			window.storeController=this;
			console.log("STORE OBJECT",this);
		}
		...
		Store.prototype.annotationCreated = function(annotation) {
			...
			if (__indexOf.call(this.annotations, annotation) < 0) {
				...
				//console.log("ANNOTATION CREATED!",this._getAnnotations());
...
this._getAnnotations();
		...
		Store.prototype.updateAnnotation = function(annotation, data) {
			...
			//console.log("UPDATE ANNOTATION",this._getAnnotations());
